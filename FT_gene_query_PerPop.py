...
QUERY_FILE="EL_Likelihoods_PerPop_both20160209-2211_sig.csv"
...
with open(DIR+QUERY_FILE,"rU") as sites_file:
    for i,line in enumerate(sites_file):
        ...
        if i==0:
            line=line.strip("\n")
            line=line.split(",")       
            writer1.writerow(line+first_line+["sigBim","sigBq","sigBbr"])
            writer2.writerow(line+first_line+["sigBim","sigBq","sigBbr"])
            writer3.writerow(line+first_line+["sigBim","sigBq","sigBbr"])
                ...
                if (snp > lower and snp <= upper_bound[i]) and boo==True:                                        
                    ...
                    if ft[i]==1:
                        ...
                        try:                    
                            ...
                            line+=site[i]+["inGene"]+[line[49],line[52],line[55]]
                    ...
                    if ft[i]==1:
                        ...
                        try:
                            ...
                            line+=site[i]+["upstream"]+[line[49],line[52],line[55]]
                            writer3.writerow(line)
                        except IndexError:
                            pass                    
