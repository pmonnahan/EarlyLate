...
def main(input_file):
    ...
    OUTPUT_FILE1=OUTDIR+QUERY_FILE[:-4]+"_FTqueried_sigB_inGenes.csv"
    OUTPUT_FILE2=OUTDIR+QUERY_FILE[:-4]+"_FTqueried_sigB_upstream.csv"
    OUTPUT_FILE3=OUTDIR+QUERY_FILE[:-4]+"_FTqueried_sigB_both.csv"
    ...
    with open(INDIR+QUERY_FILE,"rU") as sites_file:
