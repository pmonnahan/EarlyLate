...
@author: patrick
"""
def main(input_file,nonsig_input_file):
    import csv
...
#                        boo=False
    ...
    Gene_oddsratio, Gene_pvalue = stats.fisher_exact([[sigFTG, nsigFTG], [sigFTUS+sigNonFTG, nsigFTUS+nsigNonFTG]])
    Upstream_oddsratio, Upstream_pvalue = stats.fisher_exact([[sigFTUS, nsigFTUS], [sigFTG+sigNonFTG, nsigFTG+nsigNonFTG]])
    Both_oddsratio, Both_pvalue = stats.fisher_exact([[sigFTUS+sigFTG, nsigFTUS+nsigFTG], [sigNonFTG, nsigNonFTG ]])
...
if __name__ == '__main__':
    ...
    main(input_file,nonsig_input_file)