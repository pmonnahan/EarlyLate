...
#    vq4=0.01275
    ...
    fo=[0.001,0.0025,0.005,0.01,0.015,0.02,0.025,0.03,0.035,0.04,0.045,0.05,0.055,0.06,0.065,0.07,0.075,0.08,0.085,0.09,0.095,0.1,0.105,0.11,0.115,0.12,0.125,0.13,0.135,0.14,0.145,0.15,0.155,0.16,0.165,0.17,0.175,0.18,0.185,0.19,0.195,0.2,0.205,0.21,0.215,0.22,0.225,0.23,0.235,0.24,0.245,0.25,0.255,0.26,0.265,0.27,0.275,0.28,0.285,0.29,0.295,0.3]
    es=[0.65,0.65,0.6,0.5,0.45,0.45,0.38,0.38,0.37,0.35,0.32,0.32,0.32,0.32,0.32,0.32,0.31,0.29,0.29,0.29,0.29,0.28,0.28,0.28,0.28,0.25,0.25,0.25,0.25,0.25,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.21,0.18,0.18,0.18,0.18,0.18,0.18,0.18,0.18,0.18,0.18]    
    for f0 in fo:
        for ess in es:
            for ES in np.arange(ess,ess+0.16,0.01):
                ...
                #                    print ime13r,ime13a,iml13r,iml13a,ime14r,ime14a,iml14r,iml14a
                                ...
                                if lrt_B_im_M12=="-":
                                    ...
                                    im_12_count1+=1.0
                                elif lrt_B_im_M12>=15.0:
                                    im_12_count+=1.0
                                if lrt_B_q_M12=="-":
                                    pass
                                elif lrt_B_q_M12>=10.0:
                                    q_12_count1+=1.0
                                elif lrt_B_q_M12>=15.0:
                                    q_12_count+=1.0
                                if lrt_B_13_M12=="-":
                                    pass
                                elif lrt_B_13_M12>=10.0:
                                    i13_12_count1+=1.0
                                elif lrt_B_13_M12>=15.0:
                                    i13_12_count+=1.0
                                if lrt_B_14_M12=="-":
                                    pass
                                elif lrt_B_14_M12>=10.0:
                                    i14_12_count1+=1.0
                                elif lrt_B_14_M12>=15.0:
                                    i14_12_count+=1.0
