...
if file5 != 0:
    out5BR=open(OUTDIR+"EL_Likelihoods_Windows_BR" + timestr + Sim_Type + ".csv","wb")
...
if file6!=0:
    out6=open(OUTDIR+"EL_Likelihoods_PerPopSigCounts_1MbWindows" + timestr + Sim_Type + ".csv","wb")
...
#            print site
        if i>0:
            ...
            if ime13r+ime13a <= min_cov or ime13r+ime13a >= max_cov or iml13r+iml13a <= min_cov or iml13r+iml13a >= max_cov:
                ...
                ximl13=2*math.asin(piml13**0.5)+normalvariate(0,viml13**0.5)
