...
INPUT_FILE="EL_Likelihoods_20150828-1214.csv"

OUTPUT_FILE1=DIR+INPUT_FILE[:-4]+"_queried_.csv"
...
#                sigY=site[38]
            ...
            for j,lower_bound in enumerate(lower):
                if snp > lower_bound and snp <= upper[j]:
                    ...
                    writer1.writerow([scaff,snp,lower_bound,upper_bound,line[4],line[5],line[6],line[7],line[8],line[9],line[10]])
                    if geneids[j]!=previd:
