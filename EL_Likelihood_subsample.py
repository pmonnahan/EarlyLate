# -*- coding: utf-8 -*-
"""
Created on Mon Dec 14 19:56:11 2015
...
#            print site
        if i>0:
            ...
            if bre13r+bre13a <= min_cov or bre13r+bre13a >= max_cov or years == "2014":
                ...
                bre13T=round((bre13r+bre13a)/2)
                s1bre13r=numpy.random.binomial(bre13T,(bre13r/(bre13r+bre13a)))
                s1bre13a=bre13T-s1bre13r
                xbre13=2*math.asin((s1bre13r/(s1bre13r+s1bre13a))**0.5)
                vbre13=(vb1+(1/(s1bre13r+s1bre13a)))
                
            if brl13r+brl13a <= min_cov or brl13r+brl13a >= max_cov or years == "2014":
                xbrl13=-99.0
                vbrl13=-99.0
            else:
                brl13T=round((brl13r+brl13a)/2)
                s1brl13r=numpy.random.binomial(brl13T,(brl13r/(brl13r+brl13a)))
                s1brl13a=brl13T-s1brl13r
                xbrl13=2*math.asin((s1brl13r/(s1brl13r+s1brl13a))**0.5)
                vbrl13=(vb2+(1/(s1brl13r+s1brl13a)))
                
            if bre14r+bre14a <= min_cov or bre14r+bre14a >= max_cov or years == "2013":
                xbre14=-99.0
                vbre14=-99.0
            else:
                bre14T=round((bre14r+bre14a)/2)
                s1bre14r=numpy.random.binomial(bre14T,(bre14r/(bre14r+bre14a)))
                s1bre14a=bre14T-s1bre14r
                xbre14=2*math.asin((s1bre14r/(s1bre14r+s1bre14a))**0.5)
                vbre14=(vb3+(1/(s1bre14r+s1bre14a)))
                
            if ime13r+ime13a <= min_cov or ime13r+ime13a >= max_cov or years == "2014":
                xime13=-99.0
                vime13=-99.0
            else:
                ime13T=round((ime13r+ime13a)/2)
                s1ime13r=numpy.random.binomial(ime13T,(ime13r/(ime13r+ime13a)))
                s1ime13a=ime13T-s1ime13r
                xime13=2*math.asin((s1ime13r/(s1ime13r+s1ime13a))**0.5)
                vime13=(vi1+(1/(s1ime13r+s1ime13a)))
                
            if iml13r+iml13a <= min_cov or iml13r+iml13a >= max_cov or years == "2014":
                ximl13=-99.0
                viml=-99.0
            else:
                iml13T=round((iml13r+iml13a)/2)
                s1iml13r=numpy.random.binomial(iml13T,(iml13r/(iml13r+iml13a)))
                s1iml13a=iml13T-s1iml13r
                ximl13=2*math.asin((s1iml13r/(s1iml13r+s1iml13a))**0.5)
                viml13=(vi2+(1/(s1iml13r+s1iml13a)))
                
            if ime14r+ime14a <= min_cov or ime14r+ime14a >= max_cov or years == "2013":
                xime14=-99.0
                vime14=-99.0
            else:
                ime14T=round((ime14r+ime14a)/2)
                s1ime14r=numpy.random.binomial(ime14T,(ime14r/(ime14r+ime14a)))
                s1ime14a=ime14T-s1ime14r
                xime14=2*math.asin((s1ime14r/(s1ime14r+s1ime14a))**0.5)
                vime14=(vi3+(1/(s1ime14r+s1ime14a)))
                
            if iml14r+iml14a <= min_cov or iml14r+iml14a >= max_cov or years == "2013":
                ximl14=-99.0
                viml14=-99.0
            else:
                iml14T=round((iml14r+iml14a)/2)
                s1iml14r=numpy.random.binomial(iml14T,(iml14r/(iml14r+iml14a)))
                s1iml14a=iml14T-s1iml14r
                ximl14=2*math.asin((s1iml14r/(s1iml14r+s1iml14a))**0.5)
                viml14=(vi4+(1/(s1iml14r+s1iml14a)))
                
            if qe13r+qe13a <= min_cov or qe13r+qe13a >= max_cov or years == "2014":
                xqe13=-99.0
                vqe13=-99.0
            else:
                qe13T=round((qe13r+qe13a)/2)
                s1qe13r=numpy.random.binomial(qe13T,(qe13r/(qe13r+qe13a)))
                s1qe13a=qe13T-s1qe13r
                xqe13=2*math.asin((s1qe13r/(s1qe13r+s1qe13a))**0.5)
                vqe13=(vq1+(1/(s1qe13r+s1qe13a)))
                
            if ql13r+ql13a <= min_cov or ql13r+ql13a >= max_cov or years == "2014":
                xql13=-99.0
                vql13=-99.0
            else:
                ql13T=round((ql13r+ql13a)/2)
                s1ql13r=numpy.random.binomial(ql13T,(ql13r/(ql13r+ql13a)))
                s1ql13a=ql13T-s1ql13r
                xql13=2*math.asin((s1ql13r/(s1ql13r+s1ql13a))**0.5)
                vql13=(vq2+(1/(s1ql13r+s1ql13a)))
                
            if qe14r+qe14a <= min_cov or qe14r+qe14a >= max_cov or years == "2013":
                xqe14=-99.0
                vqe14=-99.0
            else:
                qe14T=round((qe14r+qe14a)/2)
                s1qe14r=numpy.random.binomial(qe14T,(qe14r/(qe14r+qe14a)))
                s1qe14a=qe14T-s1qe14r
                xqe14=2*math.asin((s1qe14r/(s1qe14r+s1qe14a))**0.5)
                vqe14=(vq3+(1/(s1qe14r+s1qe14a)))
            
            if ql14r+ql14a <= min_cov or ql14r+ql14a >= max_cov or years == "2013":
                xql14=-99.0
                vql14=-99.0
            else:
                ql14T=round((ql14r+ql14a)/2)
                s1ql14r=numpy.random.binomial(ql14T,(ql14r/(ql14r+ql14a)))
                s1ql14a=ql14T-s1ql14r
                xql14=2*math.asin((s1ql14r/(s1ql14r+s1ql14a))**0.5)
                vql14=(vq4+(1/(s1ql14r+s1ql14a)))               
            ...
            if (all(k==0.0 for k in [xime13,ximl13,xime14,ximl14,xbre13,xbrl13,xbre14,xqe13,xql13,xqe14,xql14]) or all(k==math.pi for k in [xime13,ximl13,xime14,ximl14,xbre13,xbrl13,xbre14,xqe13,xql13,xqe14,xql14])):
                ...
                uq13a=((xq13[1]*wq13[1])+(xq13[0]*wq13[0]))/sum(wq13)           
                uq14a=((xq14[1]*wq14[1])+(xq14[0]*wq14[0]))/sum(wq14)
                ...
                if i>2 and i < 10000 and p_B_q<0.00001:
                    jjj+=1
                    print jjj
                    print i, s1qe14r,s1qe14a,s1ql14r,s1ql14a,s1qe13r,s1qe13a,s1ql13r,s1ql13a
                    print uq14,uq14a,uq13,uq13a
                    print vq14,xq14
                    print vq13,xq13
                    print lrt_B_q,p_B_q, df_B_q, "\n"
